...
mencoder "mf:///mnt/icelab-timelapse/SAU2-timelapse-daily/SAU2_233.17.33.246.50046_*/*.png" -mf type=png:fps=30 -ovc x264 -of lavf -o /mnt/icelab-videos/SAU-timelapse-videos/$FILENAME.h264
